...
import numpy as np
from .dataloader.base_processor_9x9 import GoDataProcessor, GoFileProcessor
...
class SevenPlaneProcessor(GoDataProcessor):
    ...
    def __init__(self, data_directory='data_9x9', num_planes=7, consolidate=True, use_generator=False):
...
class SixPlaneProcessor(GoDataProcessor):
    '''
    Implementation of a Go data processor, using seven planes of 9x9 values to represent the position of
    a go board, as explained below.
