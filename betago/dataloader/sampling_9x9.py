...
import os
import random
from .index_processor_9x9 import OGSIndex
...
class Sampler(object):
    ...
    def __init__(self, data_dir='data', num_test_games=100, cap_year=10000, seed=1337):
        self.data_dir = data_dir
        self.num_test_games = num_test_games
        self.test_games = []
        self.train_games = []
        self.test_folder = 'test_samples_9x9.py'
    ...
    #     '''
    #     available_games = []
    #     index = OGSIndex(data_directory=self.data_dir)
    #
